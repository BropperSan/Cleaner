...
public class CarHandler : MonoBehaviour
{
    ...
    public bool IsVacuumingActive => isVacuuming;
    public float CurrentThrottle => Mathf.Abs(verticalInput);
    ...
    public void TakeDamage(float amount)
    {
        ...
        if (Haptics.Instance != null)
        {
            Haptics.Instance.PlayImpact(amount);
            if (AudioManager.Instance) AudioManager.Instance.PlayImpact(amount);
        }
